...
### Fixed
- Made public schedule due dates follow normalized Bangkok business dates independently of the runtime timezone, and restored the fully migrated disposable schema after isolated historical-migration tests without masking their original failures.
