...
- Hardened intermediary assignment and disbursement persistence against blank command/provenance values, nullable reversal evidence, and PostgreSQL special numeric money values while retaining exact two-decimal and non-negative invariants where applicable.
