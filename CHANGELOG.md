...
- Replaced the stale plugin-version assertion in repository agent notes with manifest/validator/generated-profile references so future agents use the installed source of truth.
