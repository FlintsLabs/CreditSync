...
### Changed
- Updated the loan list to a maximum three-column card grid with floating responsive borrower navigation showing real names, contract counts, and borrower tags with smooth section scrolling.
