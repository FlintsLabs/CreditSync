...
### Fixed
- Prevented duplicate intermediary payouts across distinct groups for one active loan, rejected posting after loan closure, required group-level reversal for intermediary-linked payouts, isolated internal compensating keys, and exposed source transfer public IDs on reversal results and detail reads.
