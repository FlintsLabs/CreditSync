...
### Fixed
- Preserved current net carried restructure components in replacement-loan rollups and early-settlement previews, unified general and new-contract interest waivers under one deterministic economic cap, allocated waived and paid new interest once with schedule-aware FIFO provenance across multi-installment replacements, routed external settlement credits and reversals through the complete payment and funding ledgers, ignored exactly reversed downstream payments when evaluating waiver reversibility, and strengthened settlement balance and concurrency guards.
