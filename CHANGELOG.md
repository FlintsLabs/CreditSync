...
### Fixed
- Preserved gross carried restructure components in replacement-loan rollups, unified general and new-contract interest waivers under one deterministic economic cap, routed external settlement credits and reversals through the complete payment and funding ledgers, ignored exactly reversed downstream payments when evaluating waiver reversibility, and strengthened early-settlement balance and concurrency guards.
