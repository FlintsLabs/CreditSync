...
### Fixed
- Canonicalized reusable intermediary bank identity on required uppercase bank codes, rejected fully exposed four-digit account masks, replayed original assignment-create audit snapshots after later ends, and grouped multi-role managed portfolios by loan to prevent double-counting.
