...
const toolsSchemas = [
    ...
    },
    {
        ...
        description: "Calculate the exact amount required to close a specific loan today, considering pro-rated interest and all past payments.",
        parameters: {
            type: "object",
            properties: {
                loanId: {
            ...
            switch (body.tool) {
                ...
                case "calculate_loan_payoff": {
                    ...
                    const summary = calculateLoanClosingSummary(
                        ...
                        txs.map(tx => ({ amount: String(tx.amount) }))
                    );
