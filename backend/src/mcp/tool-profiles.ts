...
const payments = [
    ...
    "payment.preview", "payment.post", "payment.cancel", "payment.replacement.inspect", "payment.replacement.create", "payment.replacement.duplicate-review.preview", "payment.replacement.duplicate-review.execute", "payment.reverse", "payment.reverse-with-accrual.preview", "payment.reverse-with-accrual.execute",
