...
export async function captureAdvertisedMcpContract(): Promise<FrozenMcpContract> {
    ...
    try {
        ...
        return {
            ...
            compatibility: "Tool names, full input/output schemas, descriptions, annotations, and file-parameter metadata are frozen for plugin 9.4.0; breaking changes require plugin 10.0.0.",
