...
export async function captureAdvertisedMcpContract(): Promise<FrozenMcpContract> {
    ...
    try {
        ...
        return {
            ...
            compatibility: "Tool names, full input/output schemas, descriptions, annotations, and file-parameter metadata are frozen for plugin 11.0.0; breaking changes require plugin 12.0.0.",
            tools,
        };
    } finally {
