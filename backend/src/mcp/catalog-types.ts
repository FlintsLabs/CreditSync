export const MCP_TOOL_NAMES = [
    ...
    "payment.evidence-supplement.import-chatgpt-file", "payment.evidence-supplement.record", "payment.preview", "payment.cancel", "payment.replacement.inspect", "payment.replacement.create", "payment.replacement.duplicate-review.preview", "payment.replacement.duplicate-review.execute", "payment.identity-decision.preview", "payment.identity-decision.execute", "payment.evidence-recovery.preview", "payment.evidence-recovery.execute", "payment.post",
