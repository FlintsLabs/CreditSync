...
ALTER TABLE "loans" ADD CONSTRAINT "loans_status_check" CHECK ("status" IN ('draft', 'active', 'paid', 'defaulted', 'closed', 'renewed', 'restructured', 'cancelled', 'canceled', 'settled', 'reversed', 'replaced'));--> statement-breakpoint
