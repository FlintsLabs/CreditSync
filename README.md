...
Loan Detail keeps the existing agreement route and back navigation while separating Information, Agents, Payment History, and Repayment Schedule into accessible, localized tabs. Agent agreements are effective-dated and confirmation-gated; posted payment sources remain `Unattributed` until explicitly assigned as direct or split among agents, and displayed commissions come from backend-authoritative previews rather than client-side accounting.
