...
- view Loan Detail repayment and payment-history tables with row numbers, total-record counts, configurable page sizes, and clear paid/due/overdue status indicators
