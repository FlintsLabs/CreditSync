...
// --- Minimap Component ---
const GraphMinimap = ({ graphRef, data, width = 120, height = 120, className }: { graphRef: React.RefObject<ForceGraphMethods | undefined>, data: { nodes: any[], links: any[] }, width?: number, height?: number, className?: string }) => {
