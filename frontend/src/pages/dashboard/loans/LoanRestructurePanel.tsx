...
export function LoanRestructurePanel({ loan, onExecuted }: { loan: RestructurableLoan; onExecuted?: () => void }) {
    ...
    const [form, setForm] = useState({
        ...
        floatingMode: "percent" as "percent" | "per_thousand", floatingRate: "", floatingAccrualCycle: "daily" as "daily" | "weekly" | "monthly", firstDayTreatment: "start_next_day" as "deduct" | "start_next_day",
