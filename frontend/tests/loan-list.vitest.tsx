...
describe("LoanList", () => {
    ...
    test("shows agreed repayment details and clear dates without funding metric requests", async () => {
        vi.mocked(api.get).mockResolvedValue({ data: [
            { id: "daily", publicId: "daily", borrowerName: "Daily", principal: "5000.00", status: "active", repaymentType: "daily", installmentAmount: "250.00", totalInstallments: 12, startDate: "2026-08-01", createdAt: "2026-08-10T07:30:00.000Z" },
            { id: "floating", publicId: "floating", borrowerName: "Floating", principal: "900.00", status: "draft", repaymentType: "floating", installmentAmount: null, totalInstallments: null, startDate: null, createdAt: "2026-08-10T07:30:00.000Z" },
        ] });
