...
- This is an additive disposable compatibility proof of the 0067 row shape with the 0068-owned column absent, not proof of every historical production-data variant. All-writer concurrency, UI/MCP synchronization, temporal reflow, and full-plan gates remain open.
