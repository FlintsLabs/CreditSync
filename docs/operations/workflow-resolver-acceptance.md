...
| Deterministic `workflow.resolve` | Pure policy and authoritative service tests; no domain writes | Frozen 135-tool contract, six profile snapshots, 10.3.0 scripted evals | N/A | Implemented locally |
