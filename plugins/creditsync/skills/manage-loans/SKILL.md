...
7. Call `loan.activate` with that draft public UUID only after the activation decision is explicit. Return the activated status and audit/correlation metadata.
